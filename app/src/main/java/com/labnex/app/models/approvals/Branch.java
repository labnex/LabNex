...
public class Branch implements Serializable {
    ...
    public List<AccessLevel> getPushAccessLevels() { return pushAccessLevels; }
    public List<AccessLevel> getMergeAccessLevels() { return mergeAccessLevels; }
    public List<AccessLevel> getUnprotectAccessLevels() { return unprotectAccessLevels; }
    public String getCodeOwnerApprovalRequired() { return codeOwnerApprovalRequired; }
}
